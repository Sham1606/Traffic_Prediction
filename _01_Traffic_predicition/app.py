...
def home():
    if request.method == 'POST':
        ...
        return render_template('result2.html', plot_data=plot_data, low_value=low_value, medium_value=medium_value, high_value=high_value)
...
def results():
    ...
    return render_template('result2.html', plot_data='', low_value=0, medium_value=0, high_value=0)
